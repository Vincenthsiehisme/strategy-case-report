...
└── scripts/
    └── build_report.py               # HTML 報告建構腳本（Claude Code 環境，路徑 B）
```

視覺輸出相關規格（output-a4.md、output-slide.md、visual-ref.md、plain-text-format.md）已移至 **report-renderer skill**，由該 skill 負責渲染。
